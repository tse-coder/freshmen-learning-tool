...
<div class="flex min-h-screen flex-col bg-gradient-to-br from-gray-900 via-black to-gray-800 px-4 py-6 text-white">
	...
	<div class="flex-1 flex flex-col items-center justify-center mx-auto w-full max-w-lg rounded-2xl border border-white/10 bg-white/5 p-6 shadow-2xl backdrop-blur-lg gap-6">
