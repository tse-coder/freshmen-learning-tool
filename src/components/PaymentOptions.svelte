		...
		>
			...
			<header class="mb-4">
				...
				<p class="mt-1 text-sm text-gray-400">
					Select your preferred mobile payment to complete the purchase.
				</p>
			</header>
			...
			<div class="grid gap-4 md:grid-cols-2">
				<!-- Telebirr Card -->
				<button
					on:click={payTelebirr}
					class="flex items-center gap-4 rounded-2xl border border-white/6 bg-gray-900/40 p-4 text-left hover:scale-[1.01] focus:outline-none"
				>
